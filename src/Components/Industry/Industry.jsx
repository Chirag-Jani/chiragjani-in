...
import footerDown from '../../assets/brut-1.svg';
      ...
      <div className={styles.container}>
        <div className={styles.row}>
          <div className={styles.industryItems}>
            <div className={styles.industryCardMain}>
              <h1><img src={footerDown} alt="" /></h1>
              <h1 data-aos="fade-right">Innovating</h1>
              <h1 data-aos="fade-right">Beyond</h1>
              <h1 data-aos="fade-right">Boundaries.</h1>
            </div>
            {industries.map((industry, index) => (
              <div key={index} className="overflow-hidden">
                <div className={styles.industryCard} data-aos="fade-right">
